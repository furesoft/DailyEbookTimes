...
public partial class YogaNode
{
    ...
    public double? BorderStartWidth
    {
        get
        {
    ...
    public double? GetLayoutMargin(YogaEdge edge)
    {
    ...
    public double GetLayoutPadding(YogaEdge edge)
    {
        if (edge == YogaEdge.Left)
        {
            if (_layout.Direction == YogaDirection.RightToLeft)
